...
double precision, allocatable :: aE(:,:),aW(:,:),aS(:,:),aN(:,:),aC(:,:),bC(:,:),aCt(:,:),bCt(:,:)
integer iteration
double precision, allocatable :: phi(:,:),phiNew(:,:),bCmodified(:,:),phiPreviousTime(:,:)
double precision, allocatable :: phiAnalytical(:,:)
...
double precision t ! The time at which we seek the solution for transient problems
