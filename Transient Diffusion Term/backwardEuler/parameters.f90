...
double precision, parameter :: densityField = 1000.0D0 ! The density field is constant (incompressible flow).
...
double precision, parameter :: dt = 10 ! time step from transient problems.
