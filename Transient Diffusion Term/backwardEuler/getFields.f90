...
do i = 1,m-1
	do j = 1,n
		...
		x0fHorVelocity(i,j) = x0fVelocityFunction((X(i,j)+X(i+1,j))/2.0D0,(Y(i,j)+Y(i+1,j))/2.0D0)
		y0fHorVelocity(i,j) = y0fVelocityFunction((X(i,j)+X(i+1,j))/2.0D0,(Y(i,j)+Y(i+1,j))/2.0D0)
...
do i = 1,m
	do j = 1,n-1
		...
		x0fVerVelocity(i,j) = x0fVelocityFunction((X(i,j)+X(i,j+1))/2.0D0,(Y(i,j)+Y(i,j+1))/2.0D0)
		y0fVerVelocity(i,j) = y0fVelocityFunction((X(i,j)+X(i,j+1))/2.0D0,(Y(i,j)+Y(i,j+1))/2.0D0)
